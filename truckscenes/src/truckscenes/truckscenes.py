...
class TruckScenes:
    ...
    def render_pointcloud_in_image(self, sample_token: str, dot_size: int = 5,
        ...
        return self.explorer.render_pointcloud_in_image(sample_token, dot_size,
    ...
    def render_pointcloud_in_image_subplot(self, sample_token: str, dot_size: int = 5,
                                   pointsensor_channel: str = 'LIDAR_LEFT',
                                   camera_channel: str = 'CAMERA_LEFT_FRONT',
                                   out_path: str = None,
                                   render_intensity: bool = False,
                                   cmap: str = 'viridis',
                                   verbose: bool = True) -> None:
        return self.explorer.render_pointcloud_in_image_subplot(sample_token, dot_size,
                                                 pointsensor_channel=pointsensor_channel,
                                                 camera_channel=camera_channel,
                                                 out_path=out_path,
                                                 render_intensity=render_intensity,
    ...
    def render_sample_lidar(self, sample_token: str,
                      box_vis_level: BoxVisibility = BoxVisibility.ANY,
                      nsweeps: int = 1,
                      out_path: str = None,
                      verbose: bool = True) -> None:
        self.explorer.render_sample_lidar_only(token=sample_token, box_vis_level=box_vis_level,
                                    nsweeps=nsweeps, out_path=out_path, verbose=verbose)
        
    def render_sample_radar(self, sample_token: str,
                      box_vis_level: BoxVisibility = BoxVisibility.ANY,
                      nsweeps: int = 1,
                      out_path: str = None,
                      verbose: bool = True) -> None:
        self.explorer.render_sample_radar_only(token=sample_token, box_vis_level=box_vis_level,
                                    nsweeps=nsweeps, out_path=out_path, verbose=verbose)
        
    def render_sample_radar_lidar(self, sample_token: str,
                      box_vis_level: BoxVisibility = BoxVisibility.ANY,
                      nsweeps: int = 1,
                      out_path: str = None,
                      verbose: bool = True) -> None:
        self.explorer.render_sample_radar_lidar(token=sample_token, box_vis_level=box_vis_level,
                                    nsweeps=nsweeps, out_path=out_path, verbose=verbose)
    def render_sample_lidar_safe_space(self, sample_token: str,
                      box_vis_level: BoxVisibility = BoxVisibility.ANY,
                      nsweeps: int = 1,
                      out_path: str = None,
                      verbose: bool = True) -> None:
        self.explorer.render_sample_lidar_with_safe_space(token=sample_token, box_vis_level=box_vis_level,
                                    nsweeps=nsweeps, out_path=out_path, verbose=verbose)
    ...
    def get_pointcloud(self,
                          ...
                          cmap: str = 'viridis',
                          out_path: str = None) -> None:
        return self.explorer.get_pointcloud(sample_rec=sample_rec,
                                        chans=chans,
                                        ref_chan=ref_chan,
                                        with_anns=with_anns,
                                        box_vis_level=box_vis_level,
